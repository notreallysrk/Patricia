...
STRING_SESSION = 'BQAJi5vDwPlnSCYfPIC_mgqRw-E-T--NSyXkkHz90agz-RqVTjqZYFWiV7rF4hQABbE6_4a_badhbq42uepmMQSmYUDOICIiR4cRpx6WEUIQ9JnlSVUEFVyeaRFXIVqsuXRaThAPh3Kcsy9rb24WWllkUFDQJuqnYj2ZmzuyjgQjR_xOH1rsV1EYlMckiEG4m-lwJ1fORGKgHleZNbOYXQmavgLohk9aoschmFDfzquZEuGL2Hs0thSGzs1uOv71etz1aaS2h50AHGI07DSRQnUEGKaV6smubHUC_4A-tcaQCyKFCkosu3HENrNVRzFxDW_dnfwg-IKFIccU0HCuEi9eAAAAAUvNssUA'
API_ID = '6435225'
API_HASH = '4e984ea35f854762dcde906dce426c2d'
TOKEN = '5594511258:AAGiJHgkCOWFiInsgBT2U1zn68dDoMoo-4Q'
WORKERS = 32
# SpamWatch
sw = KInit.init_sw()
...
if not KInit.DROP_UPDATES:
    ...
    updater = tg.Updater(token=TOKEN, base_url=BOT_API_URL, base_file_url=BOT_API_FILE_URL, workers=min(32, os.cpu_count() + 4), request_kwargs={"read_timeout": 10, "connect_timeout": 10})
