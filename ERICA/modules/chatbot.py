...
from Erica import dispatcher, updater, SUPPORT_CHAT
...
__help__ = """
✗ `Chatbot utilizes the` *Erica* `api which allows Erica to talk and provide a more interactive group chat experience.`
