...
#from Rose
from ERICA.mongo.welcomedb import Greetings
from ERICA import pgram as app
from ERICA.core.decorators.permissions import adminsOnly
from ERICA.mongo.gban import GBan
from ERICA.utils.string import (
    build_keyboard,
...
The first thing to do is to add Zaid Bot ✨ to your group! 
