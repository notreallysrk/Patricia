...
from ERICA import  arq, pgram as pbot
from ERICA.core.decorators.errors import capture_err
from pyrogram import filters
from pyrogram.types import Message
from ERICA import eor, pgram as app
from ERICA.core.decorators.errors import capture_err
...
To Disable This Feature type `/antinsfw off`
**————————————————————**
__Powered By @Zaid2_Robot__
"""
    )
...
#nsfwscan 
@pbot.on_message(filters.command(["nsfwscan", f"nsfwscan@Zaid2_Robot"]))
@capture_err
