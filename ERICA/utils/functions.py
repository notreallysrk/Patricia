...
from ERICA import aiohttpsession as aiosession
from ERICA.utils.dbfunctions import start_restart_stage
from ERICA.utils.http import get, post
...
def generate_captcha():
    ...
    height = 100
    correct_answer = ""
    font = ImageFont.truetype("text/arial (2).ttf", 55)
    file = f"text/{randint(1000, 9999)}.jpg"
